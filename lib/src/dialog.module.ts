...
import { DialogServiceConfig } from './interfaces';
...
@NgModule({
  ...
  declarations: [DialogHolderComponent, DialogWrapperComponent, BuiltInComponent],
  providers: [DialogService],
  entryComponents: [DialogHolderComponent, DialogWrapperComponent, BuiltInComponent],
})
